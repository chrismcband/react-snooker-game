...
export function createInitialBalls(): Ball[] {
   ...
   balls.push({
    ...
    const apexX = TABLE_MARKINGS.pinkSpotX + BALL_PROPERTIES.radius * 2 - BALL_PROPERTIES.radius * 0.75 + BALL_PROPERTIES.radius * 0.25; // Position apex: 2 diameters minus 1/2 of a ball
